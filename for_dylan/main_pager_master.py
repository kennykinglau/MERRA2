                            ...
                            for HIGHEST_ELL in highest_ells:
                                ...
                                for MERRA_VAR in variable_list[DIM]:
                                    ...
                                    for time_type in ['tavg','inst']:
                                        ...
                                        newyRangeString,newyLabel,newxRangeString,newxLabel,statNumber,pvalue = correl.process_data(merra_data,merra_data,np.arange(merra_data.size),SPT_for_correlation,SPT_data,SPT_time_numbers,
